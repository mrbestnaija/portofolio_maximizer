...
Current status:
- Phase 1 is implemented through `etl.data_universe.resolve_ticker_universe`.
- `scripts/run_auto_trader.py` and the ETL pipeline should both reuse that helper instead of growing separate ticker-universe orchestration paths.
