...
| [OBSERVABILITY_PROMETHEUS_GRAFANA.md](OBSERVABILITY_PROMETHEUS_GRAFANA.md) | Read-only Prometheus exporter, Alertmanager shadow routing, Grafana ops dashboards, and Windows startup/provisioning |
...
- [OBSERVABILITY_PROMETHEUS_GRAFANA.md](OBSERVABILITY_PROMETHEUS_GRAFANA.md) — Prometheus exporter, Alertmanager bridge, Grafana ops dashboards, and Windows rollout contract
